    ...
    $.ajax({
    	...
    	success: function(response) {
    		$.each(response.apartments, function(i, apartment){
    		 ...
    		 var listing = "<a href='#' id=" + apartment.id + " class='list-group-item " + apartmentClass + " listings'>" + apartment.description + " / " + apartment.bedrooms + " BR / " + apartment.price + "<h4 class='list-group-item-heading'></h4><p class='list-group-item-text'>" + apartment.neighborhood + "</p></a>"
